  ...
  <div class="px-4 bg-secondary rounded-lg">
    <Block>
      <BlockTitle>
        <div class="flex flex-row items-center">
          ...
          <div
            ...
            style="background-color: {clientStatusIconColor};"
          />
      ...
      {#if currentlyConnected}
        ...
        <BlockTitle>Currently playing</BlockTitle>
        <BlockBody>
          <div class="text-white flex flex-row">
            ...
            {#if currentTrackLength}
              {formatPlayTime(currentTrackProgress)} / {formatPlayTime(
                currentTrackLength,
              )}
            {/if}
          </div>
          ...
          <div class="flex flex-row">
            <MoltenPushButton
              snap="full"
              text="Prev"
              click={() => sendSpotifyControl("previous")}
            />
            <MoltenPushButton
              snap="full"
              text="Pause"
              click={() => sendSpotifyControl("pause")}
            />
            <MoltenPushButton
              snap="full"
              text="Play"
              click={() => sendSpotifyControl("play")}
            />
            <MoltenPushButton
              snap="full"
              text="Next"
              click={() => sendSpotifyControl("next")}
            />
          </div>
        </BlockBody>
